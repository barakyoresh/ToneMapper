...
@property (strong, readonly, nonatomic) NSMutableArray *attributes;

/// Array of passed uniforms.
@property (strong, readonly, nonatomic) NSMutableArray *uniforms;

/// Name of the Vertex Shader file
@property (strong, nonatomic) NSString *vertexShaderName;

/// Name of the Fragment Shader file
@property (strong, nonatomic) NSString *fragmentShaderName;
